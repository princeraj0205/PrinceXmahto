...
['Unit 1.0 — Units and Measurements',['1.1 Physical quantities and SI units','1.2 Accuracy, precision and errors','1.3 Dimensions and dimensional formulae','1.4 Applications of dimensions','1.5 Ancient astronomical instruments']],
['Unit 2.0 — Simple Harmonic and Wave Motion',['2.1 Periodic and oscillatory motion','2.2 Simple Harmonic Motion (SHM)','2.3 Types of waves and wave parameters']],
['Unit 3.0 — Electrostatics, Electromagnetism and Electric Current',['3.1 Electric charge, field and potential','3.2 Gauss’ law and applications','3.3 Dielectric and parallel-plate capacitor','3.4 Magnetic field and Biot–Savart law','3.5 Faraday’s law, Lenz’s law and induction','3.6 DC and AC currents']],
['Unit 4.0 — Semiconductor Physics',['4.1 Energy bands and band gap','4.2 Intrinsic and extrinsic semiconductors','4.3 Depletion layer, p-n junction and rectifiers','4.4 Photocells and solar cells']],
['Unit 5.0 — Modern Physics',['5.1 Photoelectric effect','5.2 Lasers','5.3 Optical fibers','5.4 Nanotechnology']]
],'ASC');

const fundEE=S('fund-ee','2620103','Fundamentals of Electrical and Electronic Engg.',[
...
const basicEE=S('basic-ee','2620104','Basic Electrical Engineering',[
['Unit 1.0 — Basic Electrical Concepts',['Electric charge, current, voltage, resistance and power','DC and AC fundamentals','Electrical sources and basic circuit quantities']],
['Unit 2.0 — Energy Storing Elements',['Capacitors and capacitance','Inductors and inductance','Stored energy and circuit behaviour']],
['Unit 3.0 — D.C. and A.C. Circuits',['Ohm’s law and circuit laws','DC circuit analysis','AC quantities and phasors']],
['Unit 4.0 — Magnetic Circuits',['Magnetic flux, MMF and reluctance','Magnetic circuits and B-H characteristics']],
['Unit 5.0 — Electromagnetism',['Electromagnetic induction','Faraday’s and Lenz’s laws','Applications of electromagnetism']]
],'PCC');
...
const chemA=S('chem-a','2600103A','Applied Chemistry- A',[], 'BSC');
const chemB=S('chem-b','2600103B','Applied Chemistry- B',[], 'BSC');
const fundMech=S('fund-mech','2625103','Fundamentals of Mechanical Engineering',[], 'PCC');
const communication=S('communication','2600104','Communication Skills (English)',[], 'HSM');
const drawing=S('drawing','2615105','Engineering Drawing & Graphics',[], 'PCC');
const drawingME=S('drawing-me','2625105','Engineering Drawing',[], 'PCC');
const mechWorkshop=S('mech-workshop','2625106','Mechanical Workshop',[], 'PCC');
const ethics=S('ethics','2600107','Professional Ethics',[], 'HSM');
const sports=S('sports','2600008','Sports, Yoga and Meditation',[], 'HSM');
const constitution=S('constitution','2600007','Indian Constitution',[], 'HSM');
const oer=S('oer','2600009','Open Educational Resources (OER)',[], 'HSM');
const electricalWorkshop=S('workshop','2620105','Electrical and Electronics Workshop',[], 'PCC');
const mechanics=S('mechanics','2625104','Engineering Mechanics',[], 'PCC');
const environment=S('environment','2600006','Environmental Education and Sustainable Development',[], 'HSM');

const branches=[
{id:'ce',title:'Civil Engineering',code:'CE',semesters:[{id:'sem1',title:'Semester I',subjects:[math,chemA,fundMech,communication,drawing,mechWorkshop,ethics,sports]}]},
{id:'cre',title:'Civil Engineering (Rural Engineering)',code:'CRE',semesters:[{id:'sem1',title:'Semester I',subjects:[math,chemA,fundMech,communication,drawing,mechWorkshop,ethics,sports]}]},
{id:'cse',title:'Computer Science and Engineering',code:'CSE',semesters:[{id:'sem1',title:'Semester I',subjects:[math,physics,fundEE,ai,electricalWorkshop,ict,constitution,oer]}]},
{id:'ee',title:'Electrical Engineering',code:'EE',semesters:[{id:'sem1',title:'Semester I',subjects:[math,physics,basicEE,drawing,ai,electricalWorkshop,sports,oer]}]},
{id:'elx',title:'Electronics Engineering',code:'ELX',semesters:[{id:'sem1',title:'Semester I',subjects:[math,physics,chemB,mechanics,drawing,electricalWorkshop,environment]}]},
{id:'me',title:'Mechanical Engineering',code:'ME',semesters:[{id:'sem1',title:'Semester I',subjects:[math,chemA,ai,communication,drawingME,environment]}]}
];
